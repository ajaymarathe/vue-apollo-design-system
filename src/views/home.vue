                        ...
                        <div class="heading text-center">
                            ...
                            <div>
                                <a target="_blank" href="http://blog.bootcatch.com/post/vue-components-based-design-system-is-based-on-bootcatch-themes-and-vue" class="text-decoration-none">
                                 ...
                                 <a class="text-decoration-none" href="https://github.com/ajaymarathe/vue-apollo-design-system/archive/master.zip" >
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="lead mb-4"><span class="text-capitalize">{{ title }}</span> Design system comes with login and register page to help you get started, also it has it's own
                            beautiful documentation to help you out. It is based on <a href="http://www.bootcatch.com/lightly" target="_blank">Apollo Theme</a>. Which is based on Bootstrap v4.x.</p>
